...
<template>
  <div class="form-grid">
    <div class="form-field">
      ...
      <input type="color" v-model="local.lineColor" />
    </div>
    <div class="form-field">
      <label>Line width</label>
      <input type="number" min="1" step="1" v-model.number="local.lineWidth" />
    </div>
    <div class="form-field">
      <label>Curve</label>
    ...
    <div class="form-field">
      <label>X format (time)</label>
      <input type="text" placeholder="%Y-%m-%d" v-model="local.xFormat" />
    </div>
