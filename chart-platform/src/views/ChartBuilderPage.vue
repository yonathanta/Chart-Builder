...
import { chartSpecSchema, type ChartSpec } from "@legacy/specs/chartSpec";
import ChartTypeSelector from "@legacy/components/ChartTypeSelector.vue";
import ChartOptionsPanel from "@legacy/components/ChartOptionsPanel.vue";
import BarBuilderControls from "@legacy/components/BarBuilderControls.vue";
import LineBuilderControls from "@legacy/components/LineBuilderControls.vue";
import AreaBuilderControls from "@legacy/components/AreaBuilderControls.vue";
import PieBuilderControls from "@legacy/components/PieBuilderControls.vue";
import MapBuilderControls from "@legacy/components/MapBuilderControls.vue";
import DataBindingPanel from "@legacy/components/DataBindingPanel.vue";
import ScatterBuilderControls, { type ScatterBuilderConfig } from "@legacy/components/ScatterBuilderControls.vue";
import PreviewPane from "@legacy/components/PreviewPane.vue";
import { exportService, type ExportFormat } from "@legacy/export/exportService";
import type { LineChartConfig } from "@legacy/charts/line";
import type { AreaChartConfig } from "@legacy/charts/areaV7";
import type { PieConfig } from "@legacy/charts/pie";
import type { MapConfig } from "@legacy/charts/map";
import type { BarBuilderConfig } from "@legacy/components/BarBuilderControls.vue";
