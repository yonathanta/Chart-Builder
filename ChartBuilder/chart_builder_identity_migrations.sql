...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260304173854_InitialIdentitySetup'
)
BEGIN
...
BEGIN
    ...
    VALUES (N'20260304173854_InitialIdentitySetup', N'10.0.0');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260304174859_AddApplicationUserProfileFields'
)
BEGIN
...
BEGIN
    ALTER TABLE [AspNetUsers] ADD [JobTitle] nvarchar(max) NOT NULL DEFAULT N'';
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260304174859_AddApplicationUserProfileFields', N'10.0.0');
END;
